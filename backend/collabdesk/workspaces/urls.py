...
from .views import WorkspaceInformationView, WorkspaceListView, WorkspaceCreateView, WorkspaceDeleteView
...
urlpatterns = [
    ...
    path("workspaces/<uuid:workspace_id>/", WorkspaceDeleteView.as_view(), name="workspace-delete"),
]
